...
<main class="master-wrapper">
  <?php print render($page['multi_screen']);
    for($i=1;$i<21;$i++){ ?>
    <section id="view<?php echo $i?>" class="view-<?php echo $i?>">
    <div class="view--content-container">
      <div class="view--content__front">
        <?php if($i == 10){?>
        <div class="control-panel">
          <a class="control" href="javascript:;" class="refresh">Refresh</a>
        </div>
        <?php } ?>
              ...
              <?php 
                for($i=1;$i<21;$i++){ ?>
                  <div class="ipad-select--device">
                    <a href="#view<?php echo $i?>" class="ipad-select--device-chosen"><?php echo $i?></a>
                  </div>
              <?php } ?>
            </div>
          </div>
